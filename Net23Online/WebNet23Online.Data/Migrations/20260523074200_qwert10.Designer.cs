...
namespace WebNet23Online.Data.Migrations
{
    ...
    [Migration("20260523074200_qwert10")]
    partial class qwert10
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebNet23Online.Data.Models.MaksKorz.Concert", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WebNet23Online.Data.Models.MaksKorz.Location", b =>
                {
                    ...
                    b.Property<string>("NameStadium")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<int?>("TicketForMaksKorzId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("TicketForMaksKorzId");

                    b.ToTable("MKLocation");
                });

            modelBuilder.Entity("WebNet23Online.Data.Models.MaksKorz.TicketForMaksKorz", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("DataUserForMaksKorzId")
                        .HasColumnType("int");

                    b.Property<DateTime>("DateFinishConsert")
                        .HasColumnType("datetime2");

                    b.Property<DateTime>("DateStatrConsert")
                        .HasColumnType("datetime2");
                    ...
                    b.HasIndex("DataUserForMaksKorzId");
            ...
            modelBuilder.Entity("WebNet23Online.Data.Models.MaksKorz.Concert", b =>
                {
                    ...
                    b.HasOne("WebNet23Online.Data.Models.MaksKorz.Location", "Location")
                        .WithMany()
            ...
            modelBuilder.Entity("WebNet23Online.Data.Models.MaksKorz.Location", b =>
                {
                    b.HasOne("WebNet23Online.Data.Models.MaksKorz.TicketForMaksKorz", null)
                        .WithMany("LocationConcertForMK")
                        .HasForeignKey("TicketForMaksKorzId");
                });

            modelBuilder.Entity("WebNet23Online.Data.Models.MaksKorz.TicketForMaksKorz", b =>
                {
                    b.HasOne("WebNet23Online.Data.Models.MaksKorz.DataUserForMaksKorz", null)
                        .WithMany("Ticket")
                        .HasForeignKey("DataUserForMaksKorzId");
                });
            ...
            modelBuilder.Entity("WebNet23Online.Data.Models.MaksKorz.TicketForMaksKorz", b =>
                {
                    b.Navigation("LocationConcertForMK");
                });
